      ...
      <div className='partner-status-card bg-white rounded-2xl shadow-lg p-6 mb-6'>
        ...
        <div className='partner-actions mt-4 pt-4 border-t border-gray-100'>
          <p
            ...
            style={{ color: 'var(--text-light)' }}
          >
            Start your journey together with intimate reflections and deeper
            conversations.
          </p>
        </div>
      </div>
    ...
    <div className='partner-status-card bg-white rounded-2xl shadow-lg p-6 mb-6'>
      <div className='partner-invite text-center'>
        ...
        <p
          ...
          style={{ color: 'var(--text-light)' }}
        >
          AfterLove is designed for couples to explore together. Invite your
          partner to unlock the full experience.
        </p>
